...
const invoiceMessages_1 = require("./invoiceMessages");
const harvest = {
    request: () => {
...
describe('InvoiceMessages test', () => {
    ...
    let id = 1005;
    beforeEach(() => {
        instance = new invoiceMessages_1.InvoiceMessagesAPI(harvest);
        request = spyOn(instance.harvest, 'request');
    });
    it('InvoiceMessages is instantiable', () => {
        expect(instance).toBeInstanceOf(invoiceMessages_1.InvoiceMessagesAPI);
    });
...
//# sourceMappingURL=invoiceMessages.spec.js.map