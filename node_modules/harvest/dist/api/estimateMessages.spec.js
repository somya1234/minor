...
const estimateMessages_1 = require("./estimateMessages");
const harvest = {
    request: () => {
...
describe('EstimateMessages test', () => {
    ...
    let id = 1004;
    beforeEach(() => {
        instance = new estimateMessages_1.EstimateMessagesAPI(harvest);
        request = spyOn(instance.harvest, 'request');
    });
    it('EstimateMessages is instantiable', () => {
        expect(instance).toBeInstanceOf(estimateMessages_1.EstimateMessagesAPI);
    });
    ...
    it('should have a delete method that calls the request method', () => {
        ...
        expect(request).toBeCalledWith('DELETE', '/v2/estimates/1000/messages/1004');
    });
});
//# sourceMappingURL=estimateMessages.spec.js.map