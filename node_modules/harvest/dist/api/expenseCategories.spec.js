...
const expenseCategories_1 = require("./expenseCategories");
const harvest = {
    request: () => {
...
describe('ExpenseCategories test', () => {
    ...
    let id = 1000;
    beforeEach(() => {
        instance = new expenseCategories_1.ExpenseCategoriesAPI(harvest);
        request = spyOn(instance.harvest, 'request');
    });
    it('ExpenseCategories is instantiable', () => {
        expect(instance).toBeInstanceOf(expenseCategories_1.ExpenseCategoriesAPI);
    });
    ...
    it('should have an update method that calls the request method', () => {
        ...
        expect(request).toBeCalledWith('PATCH', '/v2/expense_categories/1000', query);
    });
...
//# sourceMappingURL=expenseCategories.spec.js.map